    	...
    	<div class="container-fluid">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page"><fmt:message key="label.selectBallast"/></li>
				</ol>
			</nav>
		</div>
       	<c:choose>
	        <c:when test = "${requestScope.machine.ballasts.isEmpty()}">
	        	<div class="alert alert-danger" role="alert">
					<fmt:message key="label.noBallast"/>
				</div>
	        </c:when>
	        <c:otherwise>
				<div class="container-fluid">
					<h2 class="font-weight-light"><fmt:message key="label.chooseBallast"/></h2>
