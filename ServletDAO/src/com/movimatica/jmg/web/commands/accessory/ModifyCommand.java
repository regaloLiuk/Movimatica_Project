    ...
    public void process() throws ServletException, IOException {
    	try(Connection conn = Connector.getConnection()){
	    	if(request.getMethod().equalsIgnoreCase("get")) {
		    	...
		    	request.setAttribute("accessory", DAO.getAccessoryById(conn,ServletUtils.readInt(request, "id")));
		    	//System.out.println(request.getParameter("oldId") + " " + request.getParameter("oldName"));
		        forward("/jmg/accessory/page_modify");
		        return;
	    	}
			...
			switch(DAO.updateAccessoryName(conn,new Accessory(id, map))){
				case OK:
		    ...
		    this.request.setAttribute("accessory", DAO.getAccessoryById(conn, ServletUtils.readInt(request, "id")));
	    	forward("/jmg/accessory/page_modify");	
