...
public class AccessoryCommand extends FrontCommand{
	@Override
	   public void process() throws ServletException, IOException{
			if(ServletUtils.readInt(request,"machine")==0||ServletUtils.readInt(request,"ballast")==0){
			...
			try(Connection conn = Connector.getConnection()){
	    		...
	    		request.setAttribute("ballast", ServletUtils.readInt(request, "ballast"));
			    forward("/jmg/calculator/page_select_accessory");
			    return;
