...
<html lang="${lang}">
<head>
        <title>Modify Accessory Page</title>
		...
		<div class="container-fluid">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a class="text-success" href="<c:url value = "/web/accessory/show"/>"><fmt:message key="label.accessory"/></a></li>
					<li class="breadcrumb-item active" aria-current="page"><fmt:message key="label.modify"/></li>
				</ol>
			</nav>
			<h2 class="font-weight-light"><fmt:message key="label.modifyAccessory"/></h2>
			<form action="<c:url value = "/web/accessory/modify"/>" method="post">
				<input name="id" type="hidden" value="${requestScope.accessory.id}">
				...
				<c:forEach items="${languages}" var="language">
					<div class="row justify-content-md-center">
						...
						<div class="col-10">
							...
							<input type="text" class="form-control" id="validationDefault03" name="name${i}" value="${requestScope.accessory.name.get(language)}" placeholder="Name">
						</div>
					</div>
