...
<html lang="${lang}">
<head>
        <title>modify Ballast Page</title>
    ...
    <body>
		<div class="container-fluid">
			...
			<h2 class="font-weight-light"><fmt:message key="label.modifyBallast"/></h2>
			<form action= "<c:url value = "/web/ballast/modify"/>" method="post">
				<input name="id" type="hidden" value="${requestScope.ballast.id}">
				...
				<c:forEach items="${languages}" var="language">
					<div class="row justify-content-md-center">
						...
						<div class="col-9">
							...
							<input type="text" class="form-control" id="validationDefault03" name="name${i}" value="${requestScope.ballast.name.get(language)}" placeholder="Name">
						</div>
					</div>
